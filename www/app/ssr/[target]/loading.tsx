  ...
  return (
    <Stack>
      ...
      <Text>
        ...
        champion performs in each match, based on home/away and the opponent{'\''}s finishing
        position. It then presents a new version of the standings table, that shows how each team is
        doing compared to typical championship pace, given their schedule so far.
      </Text>
